...
// mu_r_core
double mu_r_core(double t, double s, double h, const arma::vec& btj, const arma::mat& X, const arma::vec& Y, const arma::vec& S, const arma::vec& Z, double sce);
RcppExport SEXP _TrajecEstm_mu_r_core(SEXP tSEXP, SEXP sSEXP, SEXP hSEXP, SEXP btjSEXP, SEXP XSEXP, SEXP YSEXP, SEXP SSEXP, SEXP ZSEXP, SEXP sceSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type t(tSEXP);
    ...
    Rcpp::traits::input_parameter< const arma::vec& >::type Z(ZSEXP);
    Rcpp::traits::input_parameter< double >::type sce(sceSEXP);
    rcpp_result_gen = Rcpp::wrap(mu_r_core(t, s, h, btj, X, Y, S, Z, sce));
    return rcpp_result_gen;
END_RCPP
}
// mu_NP
...
// mu_surv
double mu_surv(double s, double h, const arma::vec& beta, const arma::mat& X, const arma::vec& Y, const arma::vec& S, const arma::vec& Z, double tau);
RcppExport SEXP _TrajecEstm_mu_surv(SEXP sSEXP, SEXP hSEXP, SEXP betaSEXP, SEXP XSEXP, SEXP YSEXP, SEXP SSEXP, SEXP ZSEXP, SEXP tauSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type s(sSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(mu_surv(s, h, beta, X, Y, S, Z, tau));
    return rcpp_result_gen;
END_RCPP
}
// mu_surv_core
double mu_surv_core(double s, double h, const arma::vec& beta, const arma::mat& X, const arma::vec& Y, const arma::vec& S);
RcppExport SEXP _TrajecEstm_mu_surv_core(SEXP sSEXP, SEXP hSEXP, SEXP betaSEXP, SEXP XSEXP, SEXP YSEXP, SEXP SSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type s(sSEXP);
    ...
    Rcpp::traits::input_parameter< const arma::vec& >::type Y(YSEXP);
    Rcpp::traits::input_parameter< const arma::vec& >::type S(SSEXP);
    rcpp_result_gen = Rcpp::wrap(mu_surv_core(s, h, beta, X, Y, S));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_TrajecEstm_mu_r_core", (DL_FUNC) &_TrajecEstm_mu_r_core, 9},
    ...
    {"_TrajecEstm_estimate_beta_survivor_lbfgs", (DL_FUNC) &_TrajecEstm_estimate_beta_survivor_lbfgs, 9},
